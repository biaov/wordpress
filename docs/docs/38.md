...
- 推荐将下面的 node 镜像换成 keymetrics/pm2:22-alpine 镜像，22 是 node 版本
- node 镜像：太大，1.5G 左右，如果一定要用，可以使用 node-alpine
- keymetrics/pm2:22-alpine：小，204M左右，自带 pm2 工具，简化了一些工具，比如 bash 改为 sh
